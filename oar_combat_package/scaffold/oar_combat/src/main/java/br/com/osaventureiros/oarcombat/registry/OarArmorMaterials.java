...
public final class OarArmorMaterials {
    ...
    public static final DeferredHolder<ArmorMaterial, ArmorMaterial> MYTHRIL = register("mythril", defense(3, 6, 5, 2), 22, "minecraft:diamond", OarTags.C_INGOTS_MYTHRIL, 1.0F, 0.0F);
    public static final DeferredHolder<ArmorMaterial, ArmorMaterial> ADAMANTITE = register("adamantite", defense(3, 8, 6, 3), 8, "minecraft:netherite", OarTags.C_INGOTS_ADAMANTITE, 2.0F, 0.1F);
